 ...
 * @license MIT
 */let Jy;const ec=t=>Jy=t,Xy=Symbol();function ih(t){return t&&typeof t=="object"&&Object.prototype.toString.call(t)==="[object Object]"&&typeof t.toJSON!="function"}var zs;(function(t){t.direct="direct",t.patchObject="patch object",t.patchFunction="patch function"})(zs||(zs={}));function dR(){const t=F_(!0),e=t.run(()=>_e({}));let n=[],r=[];const i=Sr({install(s){ec(i),i._a=s,s.provide(Xy,i),s.config.globalProperties.$pinia=i,r.forEach(o=>n.push(o)),r=[]},use(s){return!this._a&&!hR?r.push(s):n.push(s),this},_p:n,_a:null,_e:t,_s:new Map,state:e});return i}const Zy=()=>{};function em(t,e,n,r=Zy){t.push(e);const i=()=>{const s=t.indexOf(e);s>-1&&(t.splice(s,1),r())};return!n&&td()&&U_(i),i}function Ai(t,...e){t.slice().forEach(n=>{n(...e)})}const fR=t=>t();function sh(t,e){t instanceof Map&&e instanceof Map&&e.forEach((n,r)=>t.set(r,n)),t instanceof Set&&e instanceof Set&&e.forEach(t.add,t);for(const n in e){if(!e.hasOwnProperty(n))continue;const r=e[n],i=t[n];ih(i)&&ih(r)&&t.hasOwnProperty(n)&&!ze(r)&&!zn(r)?t[n]=sh(i,r):t[n]=r}return t}const pR=Symbol();function mR(t){return!ih(t)||!t.hasOwnProperty(pR)}const{assign:sr}=Object;function gR(t){return!!(ze(t)&&t.effect)}function _R(t,e,n,r){const{state:i,actions:s,getters:o}=e,a=n.state.value[t];let l;function c(){a||(n.state.value[t]=i?i():{});const u=K0(n.state.value[t]);return sr(u,s,Object.keys(o||{}).reduce((h,d)=>(h[d]=Sr(M(()=>{ec(n);const f=n._s.get(t);return o[d].call(f,f)})),h),{}))}return l=ev(t,c,e,n,r,!0),l}function ev(t,e,n={},r,i,s){let o;const a=sr({actions:{}},n),l={deep:!0};let c,u,h=[],d=[],f;const p=r.state.value[t];!s&&!p&&(r.state.value[t]={}),_e({});let v;function _(A){let D;c=u=!1,typeof A=="function"?(A(r.state.value[t]),D={type:zs.patchFunction,storeId:t,events:f}):(sh(r.state.value[t],A),D={type:zs.patchObject,payload:A,storeId:t,events:f});const L=v=Symbol();hn().then(()=>{v===L&&(c=!0)}),u=!0,Ai(h,D,r.state.value[t])}const w=s?function(){const{state:D}=n,L=D?D():{};this.$patch(z=>{sr(z,L)})}:Zy;function y(){o.stop(),h=[],d=[],r._s.delete(t)}function E(A,D){return function(){ec(r);const L=Array.from(arguments),z=[],F=[];function re(ee){z.push(ee)}function H(ee){F.push(ee)}Ai(d,{args:L,name:A,store:b,after:re,onError:H});let se;try{se=D.apply(this&&this.$id===t?this:b,L)}catch(ee){throw Ai(F,ee),ee}return se instanceof Promise?se.then(ee=>(Ai(z,ee),ee)).catch(ee=>(Ai(F,ee),Promise.reject(ee))):(Ai(z,se),se)}}const T={_p:r,$id:t,$onAction:em.bind(null,d),$patch:_,$reset:w,$subscribe(A,D={}){const L=em(h,A,D.detached,()=>z()),z=o.run(()=>xe(()=>r.state.value[t],F=>{(D.flush==="sync"?u:c)&&A({storeId:t,type:zs.direct,events:f},F)},sr({},l,D)));return L},$dispose:y},b=cn(T);r._s.set(t,b);const N=(r._a&&r._a.runWithContext||fR)(()=>r._e.run(()=>(o=F_()).run(e)));for(const A in N){const D=N[A];if(ze(D)&&!gR(D)||zn(D))s||(p&&mR(D)&&(ze(D)?D.value=p[A]:sh(D,p[A])),r.state.value[t][A]=D);else if(typeof D=="function"){const L=E(A,D);N[A]=L,a.actions[A]=D}}return sr(b,N),sr(we(b),N),Object.defineProperty(b,"$state",{get:()=>r.state.value[t],set:A=>{_(D=>{sr(D,A)})}}),r._p.forEach(A=>{sr(b,o.run(()=>A({store:b,app:r._a,pinia:r,options:a})))}),p&&s&&n.hydrate&&n.hydrate(b.$state,p),c=!0,u=!0,b}function yR(t,e,n){let r,i;const s=typeof e=="function";typeof t=="string"?(r=t,i=s?n:e):(i=t,r=t.id);function o(a,l){const c=Cb();return a=a||(c?Ct(Xy,null):null),a&&ec(a),a=Jy,a._s.has(r)||(s?ev(r,e,i,a):_R(r,i,a)),a._s.get(r)}return o.$id=r,o}function PU(t){{t=we(t);const e={};for(const n in t){const r=t[n];(ze(r)||zn(r))&&(e[n]=ny(t,n))}return e}}var au=()=>dR();const tm=[{path:"/",name:"/",component:()=>ke(()=>import("./index.e871ea79.js"),["assets/index.e871ea79.js","assets/index.b14ef75f.css","assets/QPage.34d16edf.js","assets/post.5ee9985e.js","assets/PostList.b22f927e.js","assets/PostItem.43085d76.js","assets/QChip.be4078ce.js","assets/PostIcon.583d3ffe.js","assets/QForm.d1e16f7f.js","assets/PostForm.f79dff31.js","assets/PostForm.e73147ee.css","assets/QItemLabel.17af6578.js","assets/format.c860d4da.js","assets/QCardActions.dec49c11.js","assets/index.4df492d2.js","assets/plugin-vue_export-helper.21dcd24c.js","assets/validate-rules.51cb0822.js"])},{path:"/_admin",name:"/_admin",component:()=>ke(()=>import("./_admin.2b83936e.js"),["assets/_admin.2b83936e.js","assets/route-block.1e6a8648.js","assets/plugin-vue_export-helper.21dcd24c.js"]),meta:{layout:"admin"}},{path:"/:path(.*)",name:"/[...path]",component:()=>ke(()=>import("./_...path_.e2517a32.js"),["assets/_...path_.e2517a32.js","assets/plugin-vue_export-helper.21dcd24c.js"])},{path:"/about",name:"/about",component:()=>ke(()=>import("./about.5478995b.js"),["assets/about.5478995b.js","assets/route-block.1e6a8648.js","assets/plugin-vue_export-helper.21dcd24c.js"]),meta:{layout:"admin"}},{path:"/admin",children:[{path:"",name:"/admin/",component:()=>ke(()=>import("./index.b2fd407a.js"),["assets/index.b2fd407a.js","assets/plugin-vue_export-helper.21dcd24c.js"])},{path:"dashboard",name:"/admin/dashboard",component:()=>ke(()=>import("./dashboard.12e69c49.js"),["assets/dashboard.12e69c49.js","assets/plugin-vue_export-helper.21dcd24c.js"])}]},{path:"/docs",children:[{path:"",name:"/docs/",component:()=>ke(()=>import("./index.0fa2d529.js"),["assets/index.0fa2d529.js","assets/plugin-vue_export-helper.21dcd24c.js"])}]},{path:"/ErrorNotFound",name:"/ErrorNotFound",component:()=>ke(()=>import("./ErrorNotFound.bf585e22.js"),["assets/ErrorNotFound.bf585e22.js","assets/plugin-vue_export-helper.21dcd24c.js"])},{path:"/home",name:"home-page",component:()=>ke(()=>import("./home.ed30caae.js"),["assets/home.ed30caae.js","assets/QPage.34d16edf.js","assets/route-block.1e6a8648.js","assets/plugin-vue_export-helper.21dcd24c.js"]),meta:{requiresAAuth:!0,width:"600px"}},{path:"/IndexPage",name:"/IndexPage",component:()=>ke(()=>import("./IndexPage.0c0b6d54.js"),["assets/IndexPage.0c0b6d54.js","assets/QPage.34d16edf.js","assets/plugin-vue_export-helper.21dcd24c.js"])},{path:"/mypage",name:"/mypage",component:()=>ke(()=>import("./mypage.b02fd498.js"),["assets/mypage.b02fd498.js","assets/QPage.34d16edf.js","assets/BaseCard.dcfb7782.js","assets/route-block.1e6a8648.js"]),children:[{path:"bookmark",name:"/mypage/bookmark",component:()=>ke(()=>import("./bookmark.1969e1ce.js"),["assets/bookmark.1969e1ce.js","assets/post.5ee9985e.js","assets/PostList.b22f927e.js","assets/PostItem.43085d76.js","assets/QChip.be4078ce.js","assets/PostIcon.583d3ffe.js"])},{path:"password",name:"/mypage/password",component:()=>ke(()=>import("./password.f882e06f.js"),["assets/password.f882e06f.js","assets/QForm.d1e16f7f.js","assets/QCardActions.dec49c11.js","assets/BaseCard.dcfb7782.js","assets/validate-rules.51cb0822.js","assets/error-message.73b8b582.js"])},{path:"profile",name:"/mypage/profile",component:()=>ke(()=>import("./profile.5b4c3d9d.js"),["assets/profile.5b4c3d9d.js","assets/QForm.d1e16f7f.js","assets/QCardActions.dec49c11.js","assets/BaseCard.dcfb7782.js","assets/error-message.73b8b582.js"])}],meta:{requiresAuth:!0}},{path:"/posts",children:[{path:":id",children:[{path:"",name:"/posts/[id]/",component:()=>ke(()=>import("./index.6f499417.js"),["assets/index.6f499417.js","assets/index.4a640d70.css","assets/QPage.34d16edf.js","assets/format.c860d4da.js","assets/post.5ee9985e.js","assets/PostIcon.583d3ffe.js","assets/index.4df492d2.js","assets/BaseCard.dcfb7782.js","assets/QForm.d1e16f7f.js","assets/validate-rules.51cb0822.js","assets/route-block.1e6a8648.js"]),meta:{width:"800px"}},{path:"edit",name:"/posts/[id]/edit",component:()=>ke(()=>import("./edit.eb31df61.js"),["assets/edit.eb31df61.js","assets/QPage.34d16edf.js","assets/post.5ee9985e.js","assets/BaseCard.dcfb7782.js","assets/PostForm.f79dff31.js","assets/PostForm.e73147ee.css","assets/QForm.d1e16f7f.js","assets/QChip.be4078ce.js","assets/QItemLabel.17af6578.js","assets/format.c860d4da.js","assets/QCardActions.dec49c11.js","assets/index.4df492d2.js","assets/plugin-vue_export-helper.21dcd24c.js","assets/validate-rules.51cb0822.js","assets/route-block.1e6a8648.js"]),meta:{width:"800px"}}]}]},{path:"/search",children:[{path:"",name:"/search/",component:()=>ke(()=>import("./index.3a4f5689.js"),["assets/index.3a4f5689.js","assets/index.2ea60985.css","assets/QPage.34d16edf.js","assets/PostItem.43085d76.js","assets/QChip.be4078ce.js","assets/PostIcon.583d3ffe.js","assets/post.5ee9985e.js"])}]},{path:"/vueuse",children:[{path:"",name:"/vueuse/",component:()=>ke(()=>import("./index.40374006.js"),["assets/index.40374006.js","assets/QPage.34d16edf.js"])}]}];/*!
  * vue-router v4.3.0
